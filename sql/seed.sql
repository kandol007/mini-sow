...
('login.email.placeholder', 'en', 'Email address'),
('login.email.placeholder', 'se', 'Epost adress'),
('login.password.label', 'en', 'Enter your password'),
...
('login.forgot', 'se', 'Glömt lösenord?'),

-- Navigation texts
('nav.home', 'en', 'Home'),
('nav.home', 'se', 'Hem'),
('nav.order', 'en', 'Order'),
('nav.order', 'se', 'Beställ'),
('nav.customers', 'en', 'Our Customers'),
('nav.customers', 'se', 'Våra Kunder'),
('nav.about', 'en', 'About us'),
('nav.about', 'se', 'Om oss'),
('nav.contact', 'en', 'Contact us'),
('nav.contact', 'se', 'Kontakta oss'),
('nav.language', 'en', 'English'),
('nav.language', 'se', 'Svenska'),

-- Footer texts
('footer.brand', 'en', '123 Fakturera'),
('footer.brand', 'se', '123 Fakturera'),
('footer.copyright', 'en', '© Lättfaktura. ORG no. 638537, 2025. All rights reserved.'),
('footer.copyright', 'se', '© Lättfaktura. ORG no. 638537, 2025. All rights reserved.'),

-- Terms page texts
('terms.title', 'en', 'Terms'),
('terms.title', 'se', 'Villkor'),
('terms.body', 'en', 'BY clicking Invoice Now, you choose to register according to the information that you have typed in and the text on the registration page and the terms here, and you at the same time accept the terms here.
...
Have a great day!'),
('terms.body', 'se', 'GENOM ATT klicka på Fakturera Nu så väljer ni att registrera enligt den information som ni har lagt in och texten på registrerings sidan och villkoren här, och accepterar samtidigt villkoren här.
...
-- Terms page button
('terms.back', 'en', 'Close and Go Back'),
('terms.back', 'se', 'Stäng och Gå Tillbaka'),

-- Menu/Pricelist texts
('menu.price_list', 'en', 'Price List'),
('menu.price_list', 'se', 'Prislista'),
('menu.logout', 'en', 'Logout'),
('menu.logout', 'se', 'Logga ut'),

-- Pricelist table headers
('pricelist.article_no', 'en', 'Article No.'),
('pricelist.article_no', 'se', 'Artikelnummer'),
('pricelist.product_service', 'en', 'Product/Service'),
('pricelist.product_service', 'se', 'Produkt/Tjänst'),
('pricelist.in_price', 'en', 'In Price'),
('pricelist.in_price', 'se', 'Inpris'),
('pricelist.price', 'en', 'Price'),
('pricelist.price', 'se', 'Pris'),
('pricelist.unit', 'en', 'Unit'),
('pricelist.unit', 'se', 'Enhet'),
('pricelist.in_stock', 'en', 'In Stock'),
('pricelist.in_stock', 'se', 'I lager');
